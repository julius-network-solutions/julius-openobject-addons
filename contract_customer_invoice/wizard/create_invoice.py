...
class create_invoice(orm.Model):
    ...
    def generate_invoice(self, cr, uid, ids, type='out_invoice', context=None):
        ...
        return self.open_invoices( cr, uid, ids, new_id, type=type, context=context)
    
    def customer_invoice(self, cr, uid, ids, context=None):
        return self.generate_invoice(cr, uid, ids, 'out_invoice', context=context)
    
    def supplier_invoice(self, cr, uid, ids, context=None):
        return self.generate_invoice(cr, uid, ids, 'in_invoice', context=context)
