        ...
        for invoice in self.browse(cr, uid, ids, context=context):
            ...
            for invoice_line in invoice_lines:
                ...
                for sale_line in sale_line_obj.browse(cr, uid, sale_line_ids, context=context):
                    ...
                    if sale_line.launch_costs != 0 and not sale_line.launch_costs_generated:
                        data_obj = self.pool.get('ir.model.data')
                        model, product_id = data_obj.get_object_reference(cr, uid, 'launch_costs', 'product_launch_costs')
                        ...
                        if value:
                            ...
                            value['price_unit'] = sale_line.launch_costs
                            value['quantity'] = 1
                        ...
                        sale_line_obj.write(cr, uid, [sale_line.id], {'launch_costs_generated' : True}, context=context)
        return True
